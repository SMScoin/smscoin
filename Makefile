...
ACLOCAL = ${SHELL} /Users/wijnandschouten/SMScoinok/build-aux/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /Users/wijnandschouten/SMScoinok/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /Users/wijnandschouten/SMScoinok/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /Users/wijnandschouten/SMScoinok/build-aux/missing automake-1.16
AWK = awk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /Users/wijnandschouten/SMScoinok/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /Users/wijnandschouten/SMScoinok
abs_srcdir = /Users/wijnandschouten/SMScoinok
abs_top_builddir = /Users/wijnandschouten/SMScoinok
abs_top_srcdir = /Users/wijnandschouten/SMScoinok
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /Users/wijnandschouten/SMScoinok/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/SMScoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/SMScoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
#$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/SMScoin-Qt

#$(OSX_DMG): $(APP_DIST_EXTRAS)
#	$(GENISOIMAGE) -no-cache-inodes -D -l -probe -V "SMScoin-Core" -no-pad -r -dir-mode 0755 -apple -o $@ dist
...
#$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/SMScoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
