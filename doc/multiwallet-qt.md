...
Only requiring some minor changes is SMScoin.cpp.
...
Changes to SMScoin.cpp
----------------------
SMScoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
