...
This document provides guidelines for internationalization of the SMScoin software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to SMScoin network</numerusform>
            <numerusform>%n active connections to SMScoin network</numerusform>
        </translation>
    </message>
