...
Format: ```mngovernance prepare proposal-name url payment-count block-start moondex-address monthly-payment-moondex```
...
Format: ```mngovernance submit proposal-name url payment-count block-start moondex-address monthly-payment-moondex fee-tx```
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single masternode (using moondex.conf setup)
