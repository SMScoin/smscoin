...
2. run moondexd with -printalert or -sendalert like this:
   /path/to/moondexd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://moondexcoin.io";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/SMScoin:0.12.0.58/"));
