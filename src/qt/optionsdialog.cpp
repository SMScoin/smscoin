    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SMSC-light"), QVariant("light"));
    ui->theme->addItem(QString("SMSC-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("SMSC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("SMSC-traditional"), QVariant("trad"));
