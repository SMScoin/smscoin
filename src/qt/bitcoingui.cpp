...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and SMScoin: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a SMScoin: URI or payment request"));
