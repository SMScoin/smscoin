    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("SMScoin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SMScoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and moondex: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About SMScoin"), this);
    aboutAction->setStatusTip(tr("Show information about SMScoin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SMScoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SMScoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SMScoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a moondex: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SMScoin help message to get a list with possible SMScoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("SMScoin client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SMScoin network", "", count));
}
...
{
    QString strTitle = tr("SMScoin"); // default title
