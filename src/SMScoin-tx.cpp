...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("SMScoin SMScoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  SMScoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded SMScoin transaction") + "\n" +
              "  SMScoin-tx [options] -create [commands]   " + _("Create hex-encoded SMScoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded SMScoin transaction
