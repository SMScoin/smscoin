...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SMScoinNetwork") type = SMScoinNetwork;
    if(strType == "SMScoinNetworkVariable") type = SMScoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SMScoinNetwork) s = "SMScoinNetwork";
    if(type == SMScoinNetworkVariable) s = "SMScoinNetworkVariable";
