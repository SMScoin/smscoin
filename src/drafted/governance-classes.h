 ...
 *
 *   // network
 *   CSMScoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.SMScoincoin.info/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSMScoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CSMScoinNetwork(UniValue objIn)
    {
...
// // can be under: SMScoinNetwork
// //   -- signature requirements : Key1(User)
// class CSMScoinNetworkVariable : public CGovernanceObject
// {
// private:
