...
{
public:
    /// Is the input associated with this public key? (and there is 2500 SMSC - checking if valid masternode)
...
private:
    ...
    /// Get the denominations for a specific amount of SMScoin.
