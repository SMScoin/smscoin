...
{
    if(fLiteMode) return; // ignore all SMScoin related functionality
...
/*
    ...
    allow endless transaction that would bloat SMScoin and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("moondex-privatesend");
